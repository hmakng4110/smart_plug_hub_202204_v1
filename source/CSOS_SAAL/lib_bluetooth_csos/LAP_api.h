...
#define PAAR_PACKET_TYPE_M2M						0x88
...
//AAT Result Packet
#define PAAR_PACKET_SIZE_ATT_ADL_DEVICE_ID			2
#define PAAR_PACKET_SIZE_ATT_ADL_ACTION				1
#define PAAR_PACKET_SIZE_ATT_LOCATION_LEN			1

#define PAAR_PACKET_INDEX_AAT_ADL_DEVICE_ID			PAAR_PACKET_INDEX_BODY_DATA_BODY
#define PAAR_PACKET_INDEX_AAT_ADL_ACTION			PAAR_PACKET_INDEX_AAT_ADL_DEVICE_ID+PAAR_PACKET_SIZE_ATT_ADL_DEVICE_ID
#define PAAR_PACKET_INDEX_AAT_LOCATION_LEN			PAAR_PACKET_INDEX_AAT_ADL_ACTION+PAAR_PACKET_SIZE_ATT_ADL_ACTION
#define PAAR_PACKET_INDEX_AAT_LOCATION				PAAR_PACKET_INDEX_AAT_LOCATION_LEN+PAAR_PACKET_SIZE_ATT_LOCATION_LEN

//HAT Result Packet
#define PAAR_PACKET_SIZE_HAT_ADL_DEVICE_ID			2
#define PAAR_PACKET_SIZE_HAT_ADL_ACTION				1
#define PAAR_PACKET_SIZE_HAT_LOCATION_LEN			1

#define PAAR_PACKET_INDEX_HAT_ADL_DEVICE_ID			PAAR_PACKET_INDEX_BODY_DATA_BODY
#define PAAR_PACKET_INDEX_HAT_ADL_ACTION			PAAR_PACKET_INDEX_HAT_ADL_DEVICE_ID+PAAR_PACKET_SIZE_HAT_ADL_DEVICE_ID
#define PAAR_PACKET_INDEX_HAT_ADL_LOCATION_LEN		PAAR_PACKET_INDEX_HAT_ADL_ACTION+PAAR_PACKET_SIZE_HAT_ADL_ACTION
#define PAAR_PACKET_INDEX_HAT_LOCATION				PAAR_PACKET_INDEX_HATT_LOCATION_LEN+PAAR_PACKET_SIZE_HAT_LOCATION_LEN
...
#define SAAL_SERVICE_ID_AAT				0x12
#define SAAL_SERVICE_ID_HAT				0x17				
#define SAAL_SERVICE_ID_SPH				0x18
#define SAAL_SERVICE_ID_SMARTFARM		0x20
#define SAAL_SERVICE_ID_FOOTPAD			0x21

#define SAAL_SERVICE_ID_DEVICE_SETUP	0xFE
