...
#define TWI_SCL			NRF_GPIO_PIN_MAP(0,7)
#define TWI_SDA			NRF_GPIO_PIN_MAP(0,8)

#define LPS_INT			NRF_GPIO_PIN_MAP(0,23)
#define HTS_INT			NRF_GPIO_PIN_MAP(0,24)
#define LIS_INT			NRF_GPIO_PIN_MAP(0,9)
